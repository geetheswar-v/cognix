...
declare module "react-hook-form" {
  ...
  type FieldPath<TFieldValues extends FieldValues> = string & keyof TFieldValues extends never
    ? string
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  type Resolver<TFieldValues extends FieldValues = FieldValues> = (values: TFieldValues, context: any, options: any) => any;
  ...
  interface UseFormRegisterReturn<TFieldElement extends HTMLElement = HTMLElement> {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  type UseFormRegister<TFieldValues extends FieldValues> = <TFieldElement extends HTMLElement = HTMLElement>(
  ...
  interface UseFormReturn<TFieldValues extends FieldValues = FieldValues> {
    ...
    setValue: (name: keyof TFieldValues & string, value: TFieldValues[keyof TFieldValues]) => void;
    getValues: (name?: keyof TFieldValues & string) => TFieldValues | TFieldValues[keyof TFieldValues];
    watch: (name?: keyof TFieldValues & string) => TFieldValues | TFieldValues[keyof TFieldValues];
    setError: (name: keyof TFieldValues & string, error: FieldError) => void;
    clearErrors: (name?: keyof TFieldValues & string | (keyof TFieldValues & string)[]) => void;
    trigger: (name?: keyof TFieldValues & string | (keyof TFieldValues & string)[]) => Promise<boolean>;
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    [key: string]: any;
  }
